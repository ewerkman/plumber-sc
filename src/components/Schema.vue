      ...
      <b-row>
         <b-col>
            <div class="form-group has-feedback has-clear">
               ...
               />
               <a
                  class="glyphicon glyphicon-remove-sign form-control-feedback form-control-clear"
         ...
         if (this.$store.state.schema) {
            this.$store.state.schema.forEach(element => {
               ...
               if (
                  ...
                  if (
                     element.$.Namespace.toLowerCase().indexOf(
               ...
               Object.keys(schemaElement.types).forEach(key => {
